...
class CountryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Country entity")
        ...
        .repeat(2) {
            ...
            .post("/api/countrys")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "countryCode":"SAMPLE_TEXT", "isoCode2":"SAMPLE_TEXT", "name":"SAMPLE_TEXT", "continent":"SAMPLE_TEXT", "region":"SAMPLE_TEXT", "surfaceArea":"SAMPLE_TEXT", "capital":"SAMPLE_TEXT", "headOfState":"SAMPLE_TEXT", "callingCode":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
